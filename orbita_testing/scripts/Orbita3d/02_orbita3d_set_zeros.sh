...
read -p 'Did you set the Obita3d in the zero position? [y/N]' SHOULD_FLASH
case $SHOULD_FLASH in
  "y"|"Y")
        ...
        DEFMT_LOG=debug cargo run --release --features=orbita3d_pvt --bin bench_Orbita3dWriteZeros
